...
export class HomeService {
  ...
  services: Service[] = [
    {
      ...
      icon: 'desktop',
      description:
        'Angular, React, Jquery, VanillaJS, HTML5, CSS / SASS, JavaScript / ES6, TypeScript, SPA, PWA, Web Sockets',
    },
    {
  ...
  technologies: Technology[] = [
    ...
    // { name: 'Styled components', image: './assets/img/tech/styled-components.png' },
    // { name: 'Tailwind', image: './assets/img/tech/tailwind-css.png' },
    ...
    { name: 'Jest', image: './assets/img/tech/jest.png' },
    { name: 'Cypress', image: './assets/img/tech/cypress.png' },
  ...
  funFact: Reference[] = [
    ...
    },
    {
      title: 'Nerd or Geek? 🤓',
      content:
        'I spent too much time coding in <a href="https://en.wikipedia.org/wiki/C_(programming_language)" target="_blank">C</a> (2012 to 2018). It was my first-class meths.. 💊',
    },
    {
      title: 'Lazy 🤫',
